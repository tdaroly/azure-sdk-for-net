...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class BackupData : ResourceData
    {
        ...
        public BackupData(AzureLocation location)
        {
            Location = location;
        }
        ...
        internal BackupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation location, string backupId, DateTimeOffset? creationOn, string provisioningState, long? size, string label, BackupType? backupType, string failureReason, string volumeName, bool? useExistingSnapshot) : base(id, name, resourceType, systemData)
        {
            Location = location;
            BackupId = backupId;
