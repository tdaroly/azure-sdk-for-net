...
namespace Azure.ResourceManager.NetApp
{
    ...
    public partial class VolumeData : TrackedResourceData
    {
        ...
        /// <param name="throughputMibps"> Maximum throughput in Mibps that can be achieved by this volume and this will be accepted as input only for manual qosType volume. </param>
        /// <param name="encryptionKeySource"> Source of key used to encrypt data in volume. Possible values (case-insensitive) are: &apos;Microsoft.NetApp&apos;. </param>
