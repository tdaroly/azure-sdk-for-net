...
namespace Microsoft.Azure.Management.ContainerApps.Models
{
    ...
    public partial class Revision : ProxyResource
    {
        /// <summary>
        ...
        /// revision</param>
        /// <param name="trafficLabels">Traffic labels associated with this
        /// revision</param>
        ...
        public Revision(string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData), System.DateTime? createdTime = default(System.DateTime?), string fqdn = default(string), Template template = default(Template), bool? active = default(bool?), int? replicas = default(int?), int? trafficWeight = default(int?), IList<TrafficLabel> trafficLabels = default(IList<TrafficLabel>), string provisioningError = default(string), string healthState = default(string), string provisioningState = default(string))
        ...
        /// <summary>
        /// Gets traffic labels associated with this revision
        /// </summary>
        [JsonProperty(PropertyName = "properties.trafficLabels")]
        public IList<TrafficLabel> TrafficLabels { get; private set; }
