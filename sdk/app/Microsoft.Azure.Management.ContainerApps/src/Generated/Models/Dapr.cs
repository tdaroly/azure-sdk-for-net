...
namespace Microsoft.Azure.Management.ContainerApps.Models
{
    ...
    public partial class Dapr
    {
        ...
        /// listening on</param>
        public Dapr(bool? enabled = default(bool?), string appId = default(string), string appProtocol = default(string), int? appPort = default(int?), int? httpReadBufferSize = default(int?))
        {
            Enabled = enabled;
            AppId = appId;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "httpReadBufferSize")]
